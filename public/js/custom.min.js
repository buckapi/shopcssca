var Pixio = function() {
    ...
    var v = function(e) {
      ...
      , /* H=function(){var e=`<div class="modal fade inquiry-modal style-1" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		...
		</div>`;"true"!=function e(t){for(var i=t+"=",n=decodeURIComponent(document.cookie).split(";"),o=0;o<n.length;o++){for(var a=n[o];" "==a.charAt(0);)a=a.substring(1);if(0==a.indexOf(i))return a.substring(i.length,a.length)}return""}("prevent_subscription")&&(jQuery("body").append(e),setTimeout(function(){jQuery("#myModal").modal("show")},5e3))},
		O=function(){$(document).on("click",".modal-content .btn-close",function(){var e,t;(e=new Date).setTime(e.getTime()+18e5),t="expires="+e.toString(),document.cookie="prevent_subscription=true;"+t+";path=/"})},N=function(){jQuery(".show-pass").on("click",function(){var e=jQuery(this).parent().find(".dz-password");"password"==e.attr("type")?(e.attr("type","text"),jQuery(this).addClass("active")):(e.attr("type","password"),jQuery(this).removeClass("active"))})}, */
